...
<body>
 	<div id="container">
		...
		<div id="mainContent">
			...
			<h1>Easter Eggs</h1>
			<center>
			<h2>Enter any site eggs you find here.</h2>
			<form action="nuggets.php" method="POST">					<p>Flags: <input type="text" name="eggs" /> <input type="submit" value="Submit" /></p>
			</form>
			<p><br><a href="../index.php">Back</a></p>
			</center>
			<center><img src="../images/wallpaper4.jpg" style="width: 90%;">					</center>
			<br>
		</div>
		<br class="clearfloat" />
		<div id="footer">
