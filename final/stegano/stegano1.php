...
<body>
 	<div id="container">
		...
		<div id="mainContent">
			...
			<center>
			<img src="../images/stego1.bmp" alt="stego1" title="stego1" />	
			<form action="stegano1.php" method="POST">		
			<p>Flag: <input type="text" name="stegano1" /> <input type="submit" value="Submit" /></p>
			<?php
			require "solved1.php";
			?>
			</form>
			<p><br><a href="../stegano.php"><< Prev</a> | <a href="stegano2.php">Next >></a></p>
			</center>  
			<br>
		</div>
		<br class="clearfloat" />
