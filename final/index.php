...
<body>
 	<div id="container">
		...
		<div id="mainContent">
			...
			<h1>News</h1>
			<p><strong>Happy One Piece 15th Anniversary!</strong></p>
			<h1>Updates</h1>
			<p><strong>I embedded background audio to the site. Enjoy!</strong></p>
...
<audio autoplay loop>
<source src="audio/opop17.mp3" type="audio/mpeg">
</audio>
</html> 
