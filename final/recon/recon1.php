...
<body>
 	<div id="container">
		...
		<div id="mainContent">
			...
			<h1>Reconnaissance 1</h1>
			<center>
			<p><a href="https://www.google.com/#q=strawhats+team"target="_blank">Click Me</a></p>
			<form action="recon1.php" method="POST">		
			<p>Flag: <input type="text" name="recon1" /> <input type="submit" value="Submit" /></p>
			<?php
			require "solved1.php";
			?>
			</form>
			<p><br><a href="../recon.php"><< Prev</a> | <a href="recon2.php">Next >></a></p>
			</center>  
			<center><img src="../images/wallpaper2.jpg" style="width: 90%;">					</center>
			<br>
		</div>
		<br class="clearfloat" />
		<div id="footer">
