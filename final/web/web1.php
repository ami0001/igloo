...
<body>
 	<div id="container">
		...
		<div id="mainContent">
			...
			<p>Flag: <input type="text" name="web1" /> <input type="submit" value="Submit" /></p>
			<?php
			require "solved1.php";
			?>
			</form>
			<p><br><a href="../web.php"><< Prev</a> | <a href="web2.php">Next >></a></p>
			</center>  
			</center>  
			<center><img src="../images/wallpaper3.png" style="width: 90%;">					</center>
			<br>
		</div>
		<br class="clearfloat" />
		<div id="footer">
