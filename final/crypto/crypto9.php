...
<body>
 	<div id="container">
		...
		<div id="mainContent">
			...
			<h1>Cryptography 9</h1>
			<center>
			<h2>6 67 15 15 68</h2>	
			<form action="crypto9.php" method="POST">		
			<p>Flag: <input type="text" name="crypto9" /> <input type="submit" value="Submit" /></p>
			<?php
			require "solved9.php";
			?>
			</form>
			<p><br><a href="crypto8.php"><< Prev</a> | <a href="crypto10.php">Next >></a></p>
			</center>  
