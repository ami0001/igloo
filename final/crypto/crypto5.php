...
<body>
 	<div id="container">
		...
		<div id="mainContent">
			...
			<h1>Cryptography 5</h1>
			<center>
			<h2>8b3a3c6860f571adce8365c46bd88611</h2>
			<form action="crypto5.php" method="POST">		
			<p>Flag: <input type="text" name="crypto5" /> <input type="submit" value="Submit" /></p>
			<?php
			require "solved5.php";
			?>
			</form>
			<p><br><a href="crypto4.php"><< Prev</a> | <a href="crypto6.php">Next >></a></p>
			</center> 
