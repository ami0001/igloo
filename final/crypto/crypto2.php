...
<body>
 	<div id="container">
		...
		<div id="mainContent">
			...
			<h1>Cryptography 2</h1>
			<center>
			<h2>NJHE MOJMQK MIK OQBID MGJID MGG XJTQ AJLER MIK KQEMHR. SJDESAEQ VE VBGG YBIK EUEQXSABID SAMS VE'QE GJJFBID YJQ. SAEQE'R MGVMXR QJJH YJQ XJT, BY XJT VMIIM OE HX YQBEIK. VE MQE, VE MQE JI SAE NQTBRE! VE MQE! YGMD BR VE MQE!</h2>
			<form action="crypto2.php" method="POST">		
			<p>Flag: <input type="text" name="crypto2" /> <input type="submit" value="Submit" /></p>
			<?php
			require "solved2.php";
			?>
			</form>
			<p><br><a href="crypto1.php"><< Prev</a> | <a href="crypto3.php">Next >></a></p>
			</center>  
