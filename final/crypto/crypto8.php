...
<body>
 	<div id="container">
		...
		<div id="mainContent">
			...
			<h1>Cryptography 8</h1>
			<center>
			<h2>15 8 1 18 1</h2>	
			<form action="crypto8.php" method="POST">		
			<p>Flag: <input type="text" name="crypto8" /> <input type="submit" value="Submit" /></p>
			<?php
			require "solved8.php";
			?>
			</form>
			<p><br><a href="crypto7.php"><< Prev</a> | <a href="crypto9.php">Next >></a></p>
			</center>  
