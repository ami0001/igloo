...
<body>
 	<div id="container">
		...
		<div id="mainContent">
			...
			<h1>Cryptography 3</h1>
			<center>
			<h2>TW9ua2V5REx1ZmZ5 </h2>	
			<form action="crypto3.php" method="POST">		
			<p>Flag: <input type="text" name="crypto3" /> <input type="submit" value="Submit" /></p>
			<?php
			require "solved3.php";
			?>
			</form>
			<p><br><a href="crypto2.php"><< Prev</a> | <a href="crypto4.php">Next >></a></p>
			</center>
