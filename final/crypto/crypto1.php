...
<body>
 	<div id="container">
		...
		<div id="mainContent">
			...
			<center>
			<h2>Sri Tmigi</h2>
			<form action="crypto1.php" method="POST">
			<p>Flag: <input type="text" name="crypto1" /> <input type="submit" value="Submit" /></p>
			<?php
			require "solved1.php";
			?>
			</form>
			<p><br><a href="../crypto.php"><< Prev</a> | <a href="crypto2.php">Next >></a></p>
			</center>  
