...
<body>
 	<div id="container">
		...
		<div id="mainContent">
			...
			<h1>Cryptography 6</h1>
			<center>
			<h2>tr aw sd wr ru</h2>		
			<form action="crypto6.php" method="POST">	
			<p>Flag: <input type="text" name="crypto6" /> <input type="submit" value="Submit" /></p>
			<?php
			require "solved6.php";
			?>
			</form>
			<p><br><a href="crypto5.php"><< Prev</a> | <a href="crypto7.php">Next >></a></p>
			</center>  
