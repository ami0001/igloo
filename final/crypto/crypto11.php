...
<body>
 	<div id="container">
		...
		<div id="mainContent">
			...
			<h1>Cryptography 11</h1>
			<center>
			<h2>4e 69 63 6f 52 6f 62 69 6e</h2>	
			<form action="crypto11.php" method="POST">		
			<p>Flag: <input type="text" name="crypto11" /> <input type="submit" value="Submit" /></p>
			<?php
			require "solved11.php";
			?>
			</form>
			<p><br><a href="crypto10.php"><< Prev</a> | <a href="crypto12.php">Next >></a></p>
			</center>  
