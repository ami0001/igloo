...
<body>
 	<div id="container">
		...
		<div id="mainContent">
			...
			<h1>Cryptography 4</h1>
			<center>
			<h2>Unhandy Snouts</h2>	
			<form action="crypto4.php" method="POST">		
			<p>Flag: <input type="text" name="crypto4" /> <input type="submit" value="Submit" /></p>
			<?php
			require "solved4.php";
			?>
			</form>
			<p><br><a href="crypto3.php"><< Prev</a> | <a href="crypto5.php">Next >></a></p>
			</center>
