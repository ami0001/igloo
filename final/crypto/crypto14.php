...
<body>
 	<div id="container">
		...
		<div id="mainContent">
			...
			<h1>Cryptography 14</h1>
			<center>
			<h2>2234243322 3215424254</h2>	
			<form action="crypto14.php" method="POST">		
			<p>Flag: <input type="text" name="crypto14" /> <input type="submit" value="Submit" /></p>
			<?php
			require "solved14.php";
			?>
			</form>
			<p><br><a href="crypto13.php"><< Prev</a> | <a href="crypto15.php">Next >></a></p>
			</center>
