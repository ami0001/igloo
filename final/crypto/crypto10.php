...
<body>
 	<div id="container">
		...
		<div id="mainContent">
			...
			<h1>Cryptography 10</h1>
			<center>
			<h2>01010010 00110000 01110010 00110000 01101110 00110000 00110100 01011010 00110000 01110010 00110000</h2>	
			<form action="crypto10.php" method="POST">	
			<p>Flag: <input type="text" name="crypto10" /> <input type="submit" value="Submit" /></p>
			<?php
			require "solved10.php";
			?>
			</form>
			<p><br><a href="crypto9.php"><< Prev</a> | <a href="crypto11.php">Next >></a></p>
			</center> 
